...
table = prettytable.PrettyTable(["Размер списка", "Время пузырька", "Время быстрой", "Время коктейльной", "Время вставкой"])
x=[]
y1=[]
y2=[]
y3=[]
...
for N in range(1000,5001,1000):
    ...
    print("Коктейльная   " +str(N)+"   заняла   "+str((t6-t5).total_seconds()) + "c")
    ...
    print("Вставкой   " +str(N)+"   заняла   "+str((t8-t7).total_seconds()) + "c")
